...
~cape-symbol~ and ~cape-elisp-block~ are useful for documentation of Elisp packages
...
but not in normal code. ~cape-super-capf~ is only necessary if you want to combine
