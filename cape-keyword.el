...
(defcustom cape-keyword-list
  ...
  '((c++-mode ;; https://en.cppreference.com/w/cpp/keyword
    ...
    (f90-mode ;; f90.el
     ...
     "asin" "assign" "assignment" "associate" "associated" "asynchronous" "atan"
     ...
     "c_ptr" "c_short" "c_signed_char" "c_size_t" "c_vertical_tab" "call" "case"
    ...
    (objc-mode
     ...
     "@synchronized" "@throw" "@try" "alloc" "autorelease" "bycopy" "byref" "in"
     "inout" "oneway" "out" "release" "retain")
    (perl-mode ;; cperl.el
     "AUTOLOAD" "BEGIN" "CHECK" "CORE" "DESTROY" "END" "INIT" "__END__"
     "__FILE__" "__LINE__" "abs" "accept" "alarm" "and" "atan2" "bind" "binmode"
     ...
     "lock" "log" "lstat" "lt" "map" "mkdir" "msgctl" "msgget" "msgrcv" "msgsnd"
    ...
    (scheme-mode ;; R7RS-small: https://small.r7rs.org/
     ...
     "current-input-port" "current-jiffy" "current-output-port" "current-second"
     ...
     "positive?" "procedure?" "promise?" "quasiquote" "quote" "quotient" "raise"
     ...
     "string->utf" "string->vector" "string-append" "string-ci<=?" "string-ci<?"
     ...
     "unquote" "unquote-splicing" "utf->string" "values" "vector" "vector->list"
